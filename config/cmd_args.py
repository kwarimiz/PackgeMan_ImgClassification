...
def parse_args():
    ...
    parser.add_argument('-b', '--batch_size', type=int, metavar='', help='the number of batch size', default=256)
    ...
    parser.add_argument('-w', '--weight', type=str, metavar='', help='the weight name', default='default')
