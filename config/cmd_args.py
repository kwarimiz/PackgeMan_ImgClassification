...
def parse_args():
    ...
    parser.add_argument('-w', '--weight', type=str, metavar='', help='the weight name', default=None)
    ...
    parser.add_argument('--gpu_num', type=int, metavar='', help='the number of gpu', default=8)
